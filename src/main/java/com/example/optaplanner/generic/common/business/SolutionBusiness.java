...
package com.example.optaplanner.generic.common.business;
...
public class SolutionBusiness<Solution_> {
    ...
    public void registerForBestSolutionChanges(final SolverAndPersistence solverAndPersistence) {
        solver.addEventListener(event -> {
            ...
            if (solver.isEveryProblemFactChangeProcessed()) {
                ...
                SwingUtilities.invokeLater(() -> {
                    ...
                    solverAndPersistence.bestSolutionChanged();
                });
            }
        });
    }
    ...
    public Solution_ solve(Solution_ problem) {
        Solution_ result = solver.solve(problem);
        System.out.println("print result is=="+result.toString());
        return result;
    }
