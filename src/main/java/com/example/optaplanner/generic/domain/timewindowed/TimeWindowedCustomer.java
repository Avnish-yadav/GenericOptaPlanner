...
package com.example.optaplanner.generic.domain.timewindowed;

import com.example.optaplanner.generic.domain.Customer;
import com.example.optaplanner.generic.domain.timewindowed.solver.ArrivalTimeUpdatingVariableListener;
