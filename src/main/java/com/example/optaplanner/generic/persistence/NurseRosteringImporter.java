...
import com.example.optaplanner.generic.common.persistence.AbstractXmlSolutionImporter;
import com.example.optaplanner.generic.common.persistence.SolutionConverter;
import com.example.optaplanner.generic.config.NurseRosteringApp;
import com.example.optaplanner.generic.domain.*;
import com.example.optaplanner.generic.domain.contract.*;
import com.example.optaplanner.generic.domain.pattern.*;
import com.example.optaplanner.generic.domain.request.DayOffRequest;
import com.example.optaplanner.generic.domain.request.DayOnRequest;
import com.example.optaplanner.generic.domain.request.ShiftOffRequest;
import com.example.optaplanner.generic.domain.request.ShiftOnRequest;
import com.example.optaplanner.generic.jdom.DataConversionException;
...
public class NurseRosteringImporter extends AbstractXmlSolutionImporter<NurseRoster> {
    ...
    private static Logger logger = LoggerFactory.getLogger("NurseRosteringImporter");
